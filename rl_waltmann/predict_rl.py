...
DATA_IN_TEST = 'data/in/test_waltmann_data_cleaned.csv'  # This should be the test set created by create_test_df.py
NO_REWARDS = False  # Set to True to use prompts that do not include reward information
...
def predict_participant(df_participant, model, tokenizer):
    ...
    # Create random choice options from all capital letters
...
def main():
    ...
    timeline = timeline.rename(columns={'subject': 'model_id'})
