...
import os
from multi_cue_prompt import build_prediction_multicue_prompt
...
def predict_participant(participant_df, model, tokenizer):
    ...
    full_prompt = build_prediction_multicue_prompt(participant_df)
...
def main():
    ...
    for p in participant_ids:
        ...
        if RUN_TEST_SET_ONLY:
            full_prompt = build_prediction_multicue_prompt(model_data)
